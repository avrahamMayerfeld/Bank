...
public class Bank03 {
	...
	case "Savings":
	case "savings":{SavingsAccount03 a=new SavingsAccount03(name,number);
	listOfAccounts.add(a);
	break;}
	case "Checking":
	case "checking":{CheckingAccount03 b=new CheckingAccount03(name,number);
	listOfAccounts.add(b);
	break;}
	case "cd":
	case "CD":{CDAccount03 c=new CDAccount03(name,number);
	...
	public static void main(String[]args){
		...
		{ public void run(){BankDatabase.store();} } );
